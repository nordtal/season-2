 ...
 * {@code Glyphs.BOSSBAR_ARROWS} indices, shared by every HUD that points at something.
 *
 * <p>No Bukkit type appears here - yaw and the coordinates are plain doubles - so the whole
 * calculation is a plain unit test.
 */
public final class Bearing {
     ...
     * yaw - 0 is straight ahead, clockwise from there.
     *
    ...
    public static int arrowIndex(final double playerX, final double playerZ, final double playerYawDegrees,
        ...
        // atan2(-dx, dz) is the bearing in Minecraft's own yaw convention: 0 faces +Z (south) and
        // increases clockwise.
