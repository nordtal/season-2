 ...
 *
 * <b>Why this is in :common and not three times over</b>
 *
 ...
 *
 * So the composition is here, the wording is in the {@code tab.header} / {@code tab.footer} keys
 ...
 * they are looking at, which is where they already are.
 *
 * <b>The logo is a parameter, not a character in a .properties file</b>
 *
 ...
 *
 * <b>The counts are this server's</b>
 *
