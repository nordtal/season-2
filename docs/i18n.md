...
smp/src/main/resources/messages/smp/{en,de}.properties              # not yet — the module is a scaffold
```

The first four exist; `limbo`'s were written on 2026-09-01. **`limbo`'s bundle is unusual and worth
