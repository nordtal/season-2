...
|---|---|---|---|
| `smp` | 94 files, 13 160 lines | 173 | Everything docs/smp.md describes, none of it yet seen on a running server |
...
1051 tests, none skipped, all green with a Docker daemon present (`./gradlew build`, 2026-09-04),
