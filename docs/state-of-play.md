...
after the fact. **Findings 9, 30, 48, 52 and 59 still stand**; every other row is closed (19 and 22 by their own rows, 33 on 2026-09-02 when the packages went public, 54 by the command table in `docs/README.md`). Keeping that sentence
