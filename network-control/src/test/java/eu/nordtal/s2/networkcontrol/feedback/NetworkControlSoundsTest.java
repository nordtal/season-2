...
/**
 * The mapping table {@link NetworkControlSounds} adds: {@link Feedback#REFUSED} plays a real
 ...
 * that {@code NetworkControlSounds} calls it with the sound this table says {@code REFUSED} means.
 */
class NetworkControlSoundsTest {
    ...
    void refusedPlaysTheSharedSound() {
        ...
        final NetworkControlSounds sounds = NetworkControlSounds.defaults(problems::add);
    ...
    void everythingElseIsSilent() {
        final List<Sound> played = new ArrayList<>();
        final NetworkControlSounds sounds = NetworkControlSounds.defaults(problem -> {
