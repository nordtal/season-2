...
import eu.nordtal.s2.networkcontrol.pack.LimboHold;
...
class BackendKickLoopTest {
    ...
    void withoutTheBreakerASecondKickWouldFollowImmediately() {
        ...
        assertEquals(Optional.empty(),
                LimboHold.reason(true, SeasonPhase.SMP, false, registeredButNotHealthAware, false),
    ...
    void withTheBreakerThePlayerWaitsOnceAndIsFetchedOnceSmpIsHealthy() {
        ...
        assertEquals(Optional.of(WaitReason.BACKEND),
                LimboHold.reason(true, SeasonPhase.SMP, false, !health.isSuspended(SMP), false),
