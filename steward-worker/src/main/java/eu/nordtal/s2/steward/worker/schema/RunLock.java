 ...
 * Two workers can be alive at once, and the arrangement invites it: the daemon runs all the time,
 * and the documented bootstrap is a one-shot {@code docker compose run --rm steward-worker bootstrap} that an
