...
class ConfigApiNestedChangeTest {
    ...
    void nestedListsArriveAsLists() {
        final Map<String, ConfigChange> changes = ConfigApi.changesOf(JsonParser.parseString("""
                {"changes": {"milestones": [
        ...
        assertEquals(ConfigChange.sections(List.of(
                Map.of("key", "foothold", "objectives", List.of(
                        Map.of("key", "logs", "target", "64", "items", List.of("OAK_LOG", "SPRUCE_LOG")),
